        ...
        <div class="w-full max-w-7xl mx-auto px-6 lg:px-8 overflow-x-auto">
          <div class="flex flex-col md:flex-row max-md:gap-3 items-center justify-between mb-5">
            ...
            <div class="flex items-center gap-px rounded-lg bg-gray-100 p-1">
              <button class="rounded-lg py-2.5 px-5 text-sm font-medium text-gray-500 transition-all duration-300 hover:bg-white hover:text-indigo-600">Dia</button>
              <button class="rounded-lg py-2.5 px-5 text-sm font-medium text-indigo-600 bg-white transition-all duration-300 hover:bg-white hover:text-indigo-600">Semana</button>
              <button class="rounded-lg py-2.5 px-5 text-sm font-medium text-gray-500 transition-all duration-300 hover:bg-white hover:text-indigo-600">Mes</button>
            </div>
            <!--Boton-->
    <div class="py-2.5 pr-7 pl-5 bg-indigo-600 rounded-xl flex items-center gap-2 text-base font-semibold text-white transition-all duration-300 hover:bg-indigo-700">
