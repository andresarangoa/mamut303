                ...
                <div class="p-4 md:p-5 space-y-4">
                    ...
                    <div class="flex gap-5 mb-5">
                        <div class="flex-1">
                            ...
                            <input type="number" id="price" name="price" value="{{ $repair->price }}"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-purple-500 focus:border-purple-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-purple-500 dark:focus:border-purple-500" />
                            @error('price')
                                <p id="filled_error_help" class="mt-2 text-xs text-red-600 dark:text-red-400">
                                    {{ $message }}
                        ...
                        <div class="flex-1">
                            ...
                            <select id="status" name="status"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-purple-500 focus:border-purple-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-purple-500 dark:focus:border-purple-500">
                                <option value="Pending" @selected($repair->status == 'Pending')>
                                    {{ __('messages.repair_status_list.pending') }}</option>
                                <option value="In Progress" @selected($repair->status == 'In Progress')>
                                    {{ __('messages.repair_status_list.in_progress') }}</option>
                                <option value="Completed" @selected($repair->status == 'Completed')>
